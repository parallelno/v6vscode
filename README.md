...
- **v6emul tools view** — the `v6emul` Activity Bar container, also available through **View > Open View... > v6emul**, toggles Settings, Display, Hex Viewer, Memory Edits, Symbols, Ports, and Watchpoints editor panels
...
- **Standalone debug tools** — full-size Hex Viewer, Memory Edits, Symbols, Ports, and Watchpoints editor panels
